...
class WideResNet(nn.Module):
    def __init__(self, depth, num_classes, num_colors=3, widen_factor=1, dropRate=0.0):
...
class WideResNetAux(nn.Module):
    def __init__(self, depth, num_classes, num_aux_classes,
                 num_colors=3, widen_factor=1, dropRate=0.0):
        ...
        self.bn1 = nn.BatchNorm2d(nChannels[3])
        self.relu = nn.ReLU(inplace=True)
        self.fc_cls = nn.Linear(nChannels[3], num_classes)
        self.fc_aux = nn.Linear(nChannels[3], num_aux_classes)
        self.nChannels = nChannels[3]
